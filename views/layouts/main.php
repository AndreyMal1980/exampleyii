...
<html lang="<?= Yii::$app->language ?>">
    ...
    <body>
        ...
        <section id="header">
            ...
            <div class="middleheader">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="margin-top: 13px">
            ...
            <header>
                <div class="container">
                    <div id="forma-search-top">
                        <form role="form" class="form-group form-group-lg">
                            <div class="form-group">
                                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                                    <input type="text" class="form-control" id="text" placeholder="Я ищу мастера по ремонту">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                            ...
                            <div class="form-group">
                                <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                                    <button type="submit" class="btn btn-info btn-lg form-control search-btn"></button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="bottom-header">
                <div class="container">
                    ...
                    <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">   
                        ...
                        <div id="forma-search">
                            <form role="form" class="form-group form-group-md">
                                <div class="form-group">
                                    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                                        <input type="text" class="form-control " id="text" placeholder="Я ищу мастера по ремонту">
                                    </div>
                        ...
                        <?php if (!Yii::$app->user->isGuest) { ?>
                            <a class="avtoriz avtoriz-bottom" style="margin-top: 10px;display: inline-block;" href="<?php echo \yii\helpers\Url::to(['/site/logout']) ?>"><span>Выйти(<?= Yii::$app->user->identity['username'] ?>)</span></a>
                        <?php } else { ?>
                            <a style="margin-top: 10px;display: inline-block;" class="avtoriz avtoriz-bottom" href="<?php echo \yii\helpers\Url::to(['/site/registration']) ?>"><span>Войти</span></a>
                        <?php } ?>
                    </div>
                    <div class="col-lg-2 col-md-12 col-sm-12 col-xs-6 text-center">
                        <a href="<?= \yii\helpers\Url::to('site/contact') ?>"><button style="margin-top: 15px;" type="button" class="btn btn-info btn-lg  call-zakaz">Поручить заказ</button></a>   
                    </div>
