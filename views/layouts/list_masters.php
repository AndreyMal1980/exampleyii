                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="margin-top: 13px">
                            <div class="col-lg-12 col-md-6 col-sm-3 col-xs-12" style="margin-top: 13px">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                    <a class="scrolling" href=".topheader"><img src="<?= Yii::$app->request->baseUrl; ?>/img/button-scrolling.png"></a>
                </div>
            </div>
        </div>
        <section id="footer">
